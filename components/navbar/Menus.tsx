  ...
  return (
    <div>
        <div className='abolute w-full h-screen bg-slate-100 flex flex-col justify-center items-center z-[150] dark:bg-slate-900 top-0 left-0'>
            ...
            <Link onClick={onClick} href='#home' className='w-[75%] flex justify-center gap-2 items-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 hover:scale-110 ease-in duration-200 dark:bg-slate-700 dark:shadow-gray-100 dark:shadow-md'>
