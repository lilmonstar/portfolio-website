  ...
  return (
    <div className='w-full h-screen flex flex-col items-center justify-evenly'  id='about'>
      ...
      <div className='flex flex-col items-center justify-center gap-6 md:flex-row'>
        ...
        <div>
          <p className='max-w-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore cupiditate quod laborum dolor magni vero quisquam exercitationem explicabo consequatur expedita illum reprehenderit, a eum. </p>
        </div>
      </div>
    </div>
  )
