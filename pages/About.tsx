  ...
  return (
    <div className='w-full h-screen flex flex-col items-center justify-center gap-10 sm:gap-12 md:gap-14 lg:gap-16'  id='about'>
      ...
      <div className='flex flex-col items-center justify-center gap-6 md:flex-row'>
        ...
        <div className='max-w-xs ms:max-w-md lg:max-w-lg mx-4'>
          <p>Work in progress... Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore cupiditate quod laborum dolor magni vero quisquam exercitationem explicabo consequatur expedita illum reprehenderit, a eum. </p>
        </div>
      </div>
    </div>
  )
